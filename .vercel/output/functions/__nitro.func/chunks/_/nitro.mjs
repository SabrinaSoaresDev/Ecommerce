...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "db0f448e-457a-4e36-ac6c-b7dfaff4a5b8",
...
const _lazy_3x4KTj = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_3x4KTj, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_3x4KTj, lazy: true, middleware: false, method: undefined }
];
