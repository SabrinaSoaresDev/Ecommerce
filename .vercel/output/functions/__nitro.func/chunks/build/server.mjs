import { hasInjectionContext, getCurrentInstance, defineComponent, createElementBlock, ref, provide, h, inject, computed, unref, Suspense, Fragment, createApp, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-CLJ4MzlU.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D9TfmSmc.mjs')
  },
  {
    name: "success",
    path: "/success",
    component: () => import('./success-BoNo5EuY.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-DWGxxrSO.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DJ9RfD9X.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DOgd6kXR.mjs'));
